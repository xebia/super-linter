...
| **Kubernetes**                    | [Checkov](https://www.checkov.io/)                                                                                                                                                                                        | See YAML formatters                                                                                                |
...
| **Vue**                           | [eslint-plugin-vue](https://eslint.vuejs.org/)                                                                                                                                                                            | [Prettier](https://prettier.io/)                                                                                   |
   ...
   jobs:
     build:
       ...
       steps:
         ...
         - name: Super-linter
           uses: super-linter/super-linter@v8.0.1 # x-release-please-version
           env:
             # To report GitHub Actions status checks
